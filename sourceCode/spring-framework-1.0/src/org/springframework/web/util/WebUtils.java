...
public abstract class WebUtils {
	...
	public static Map getParametersStartingWith(ServletRequest request, String base) {
		// todo mark 从发行版 5 开始, 'enum' 为关键字, 而不用作标识符
		Enumeration enum3 = request.getParameterNames();
		Map params = new HashMap();
		if (base == null) {
			base = "";
		}
		while (enum3 != null && enum3.hasMoreElements()) {
			String paramName = (String) enum3.nextElement();
